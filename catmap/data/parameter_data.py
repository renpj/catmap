...
shomate_params['C5H4O2_g:100-1500'] = [-16.36694, 0.46958, -0.000331925,
                                       0.0000000850912, 198590.9145, -1661.34999, -15.68938,
                                       12461.34999]  # Added by N. Shan, KSU from NIST/CRC
shomate_params['C5H6O2_g:100-1500'] = [-18.57626, 0.50733, -0.000335824, 0.0000000828263,
                                       231619.2141, -6357.53523, 2.75692,
                                       7057.53523]  # Added by N. Shan, KSU from NIST/CRC
shomate_params['C5H6O_g:50-1500'] = [1.26847, 0.35388, -0.000173962, 0.0000000287427,
                                     48401.71207, -5691.94893, -85.38991,
                                     7191.94893]  # Added by N. Shan, KSU from NIST/CRC
...
ideal_gas_params = {
    'H2_g': [2, 'linear', 0],  # [symmetry_number, geometry, spin]
    'N2_g': [2, 'linear', 0],
    'O2_g': [2, 'linear', 1.0],
    'H2O_g': [2, 'nonlinear', 0],
    'CO_g': [1, 'linear', 0],
...
experimental_gas_frequencies = {'CO_g': [2170],  # from CCCBDB, NIST webbook, or CRC
                                ...
                                'C2H6_g': [2954, 1388, 995, 289, 2896, 1379, 2969, 2969, 1468, 1468, 1190, 1190, 2985,
                                           2985, 1469, 1469, 822, 822],
                                'CH3COOH_g': [3583, 3051, 2944, 1788, 1430, 1382, 1264, 1182, 989, 847, 657, 581, 2996,
                                              1430, 1048, 642, 534, 93],
                                'CH3CHO_g': [3005, 2917, 2822, 1743, 1441, 1400, 1352, 1113, 919, 509, 2967, 1420, 867,
                                             763, 150],
                                }
