...
class ReactionModel:
        ...
        for rxn_index, rxn in enumerate(equations):
            ...
            for key in ['initial_state', 'transition_state', 'final_state']:
                ...
                if state_str:
                    ...
                    elif key == 'transition_state' and len(state_strings) == 1 and state_strings[0].startswith(
                            'echemTS'):
                        try:
    ...
    def model_summary(self, summary_file='summary.tex'):
        ...
        for spec in self.gas_names:
            ...
            reference = '\parbox[t]{4cm}{' + cleanstring(
                self.species_definitions[spec]['formation_energy_source']) + '}'
    ...
    def generate_echem_TS(self):
        ...
        for echem_TS in self.echem_transition_state_names:
            ...
            self.species_definitions[echem_TS]['formation_energy_source'] = ["Generated by CatMAP"] * len(
                self.surface_names)
            ...
            self.species_definitions[echem_TS][
                'n_sites'] = 1  # Someone may want to change this to be user-specified at some point
