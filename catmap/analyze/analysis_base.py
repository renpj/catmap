...
basic_colors = [[0, 0, 0], [0, 0, 1], [0.1, 1, 0.1],  # black,blue,green
                [1, 0, 0], [0, 1, 1], [1, 0.5, 0],  # red,cyan,orange
                [1, 0.9, 0], [1, 0, 1], [0, 0.5, 0.5],  # yellow,magenta,turquoise
                [0.5, 0.25, 0.15], [0.5, 0.5, 0.5]]  # brown,gray
